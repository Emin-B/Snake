window.onload = function(){
    ...
    function gameOver(){
        ...
        ctx.strokeText("Appuyer sur la touche Espace pour rejouer", centreX, centreY -160);
        ctx.fillText("Appuyer sur la touche Espace pour rejouer", centreX, centreY -160);
        ctx.restore();
    }
